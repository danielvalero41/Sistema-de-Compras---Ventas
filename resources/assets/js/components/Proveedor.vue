                    ...
                    <div class="modal-content compacto">
                        ...
                        <div class="modal-body compacto">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <!--Aqui agregamos el campo exclusivo del componente proveedor-->
                                <div class="form-group row">
    ...
    export default {
        ...
        data (){
            return {
                ...
                email : '',
                /**
                 * Variables exclusivas de la tabla proveedor */
                contacto : '',
                telefono_contacto : '',
                /**
            ...
            */
            listarPersona (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                     ...
                     * arreglo "arrayPersona" respuesta.persona.data lo cual no trae ningun registro
        ...
        mounted() {
             ...
             */
            this.listarPersona(1,this.buscar,this.criterio);//Hacemos referencia al metodo listarCategoria
        }
    }
</script>
