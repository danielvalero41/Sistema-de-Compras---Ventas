                            ...
                            <tbody>
                                ...
                                <tr v-for="venta in arrayVenta" :key="venta.id">
                                    <td class="text-center">
                                        ...
                                        <button type="button" @click="verVenta(venta.id)" class="btn btn-success btn-sm compacto" title="Ver Detalles de Venta">
                                          <i class="icon-eye"></i>
                                        </button> &nbsp;
                                        <!--Con este boton vamos a descargar los datos
                                        de la venta en un pdf-->
                                        <button type="button" @click="pdfVenta(venta.id)" class="btn btn-info btn-sm compacto" title="Descargar Reporte">
                                          <i class="icon-doc"></i>
                                        </button> &nbsp;
                                        ...
                                        <template v-if="venta.estado=='Registrado'">
                                            <button type="button" class="btn btn-danger btn-sm compacto" @click="desactivarVenta(venta.id)" title="Anular Registro">
                    ...
                    <template v-else-if="listado==0">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for=""><strong>Numero de cedula:</strong></label>
                                        ...
                                        porque en el metedo selectCliente recibia una variable "search" y el cual
                                        no la estabamos mandando por eso salia indefinida y no hacia ningun filtro
                                        NOTA2: Lo que hicmos para asignarle el idCliente del v-select fue enlazar una
                                        variable que creamos en la propiedad data llamada "val1" el cual obtiene todo
                                        arreglo del arrayCliente que seleccionamos en la lista por medio de "options". Ya con esto lo que 
                                        hacemos es enviar por parametro la variable val1 que ahora es un objeto y 
                                        en el metodo getDatosCliente alli la asignamos a la propiedad idCliente-->
                                        <v-select
                                            
                                            @search="selectCliente(search)"
                                            label="num_documento"                                                                    
                                            :options="arrayCliente"   
                                            v-model="val1"                           
                                            placeholder="Buscar por numero de cedula..."
                                            @input="getDatosCliente(val1)"                                        
                                        >
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control compacto" readonly style="background:white;" v-model="nomcliente">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for=""><strong>Direccion</strong></label>
                                        <input type="text" class="form-control compacto" v-model="dircliente" readonly style="background:white;">
                                    </div>
                                </div>
                            </div>                            
                        ...
                        <div class="form-group row compacto">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0"  class="form-control compacto" v-model="cantidad" readonly>
                                </div>    
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0"  class="form-control compacto" v-model="descuento">
                                </div>    
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <tbody v-if="arrayDetalle.length">
                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                            <td>
                                                ...
                                                parametro index-->
                                                <button @click="eliminarDetalle(index)" type="button" class="btn btn-danger compacto btn-sm">
                                            ...
                                            <!--Precio-->
                                            <td>                                                
                                                <input type="number" v-model="detalle.precio"  class="form-control compacto">
                                            </td>
                                            <!--Cantidad-->
                                            <td>
                                                <span style="color:red;" v-show="detalle.cantidad>detalle.stock">Stock: {{detalle.stock}}</span>
                                                <input type="number" v-model="detalle.cantidad"  class="form-control compacto">
                                            </td>
                                            <!--Descuento-->
                                            <td>
                                                <span style="color:red;" v-show="detalle.descuento>(detalle.precio * detalle.cantidad)">Descuento superior</span>
                                                <input type="number" v-model="detalle.descuento"  class="form-control compacto">
                                            </td>
                                            <!--Sub-total-->
                                            <td>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-primary compacto" @click="registrarVenta()">Registrar Venta</button>
                            </div>
                        </div>
                    </div>
                    </template>
    ...
    export default {
        ...
        methods : {
            ...
            */
            ...
            /**
             * Con esto mediante axios hacemos referencia a la ruta que llama la funcion "selectCliente" de nuestro 
            ...
            getDatosCliente(val1){
                ...
                if(val1==null){
                    ...
                    me.nomcliente = val1.nombre;
                    me.dircliente = val1.direccion;
                }
            ...
            registrarVenta(){
                ...
                axios.post(this.ruta +'/venta/registrar',{
                     ...
                     * Y el tercero sera fehca-hora 
                     */
                    me.listado=1;
                    me.listarVenta(1,'','fehca-hora');
                    me.idcliente= 0;
            ...
            validarVenta(){
                ...
                /**
                 * Colocamos el codigo para validar que la cantidad
                 * no supere al stock
                 */
            ...
            mostrarDetalle(){
                let me = this;
                var url= this.ruta +'/venta/comprobante';
                axios.get(url).then(function (response) {                    
                    var respuesta= response.data;   
                    //console.log(parseInt(respuesta.ventas.serie_comprobante) + 1);
                    
                    me.serie_comprobante = parseInt(respuesta.ventas.serie_comprobante) + 1;
                })
                .catch(function (error) {
                    console.log(error);
                });
