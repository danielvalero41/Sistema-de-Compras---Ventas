<template>
            ...
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Aqui es donde haremos la siguientes pruebas de diseño</a></li>
            </ol>
                        ...
                        <table class="table table-hover table-sm">
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="text-center">Precio del Articulo</th>
                                    <th class="text-center">Cantidad disponible del articulo</th>
    ...
    export default {
        ...
        methods : {
            ...
            listarArticulo (page,buscar,criterio){
                 ...
                 */
                var url=this.ruta + '/articuloo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
