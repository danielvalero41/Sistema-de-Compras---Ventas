...
class CreateRolesTable extends Migration
{
    ...
    public function up()
    {
        ...
        /**
         * Con este codigo me permite insertar un rol de manera estatica y de esta manera creamos la tabla roles
         * e ingresamos directamente tres registros a nuestra tabla
         */
